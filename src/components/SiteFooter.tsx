export function SiteFooter() {
  return (
    <footer className="relative z-20 border-t border-border bg-background py-14">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-10 px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6 text-muted-foreground">
          ...
          <a href="#" className="transition hover:text-foreground" aria-label="X">
            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
            </svg>
          </a>
          <a href="#" className="transition hover:text-foreground" aria-label="GitHub">
            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              <path
                fillRule="evenodd"
          ...
          <a href="#" className="transition hover:text-foreground" aria-label="YouTube">
            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
